...
AnyChart.enableChartMouseEvents = false;
...
AnyChart.prototype = {
    ...
    constructor: function(args) {
		...
		this.enableChartMouseEvents = AnyChart.enableChartMouseEvents;
    ...
    _buildFlashVars: function() {
		...
		if (this.enableChartMouseEvents) res += "&__enablechartmouseevents=1";
        if (this.messages) {
    ...
    view_updatePoint: function(viewId, seriesId, pointId, pointData) {
    ...
    */
    ...
    showAxisMarker: function(markerId, seriesData) {
